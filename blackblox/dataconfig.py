...
# LOOKUP VARIABLES
fuel_dict = dict(filepath='data/demo/fuels.xlsx',
            sheet='Fuels',
            lookup_var='fueltype')

lookup_var_dict = { 
    #FUELS
    'fuel': dict(filepath='data/demo/fuels.xlsx',
                 sheet='Fuels',
                 is_fuel = True,
                 lookup_var='fueltype'),
    'other fuel': dict(filepath='data/demo/fuels.xlsx',
                 sheet='Fuels',
                 is_fuel = True,
                 lookup_var='other fuel type'),
    'primary fuel': dict(filepath='data/demo/fuels.xlsx',
                 sheet='Fuels',
                 is_fuel = True,
                 lookup_var='primary fuel type'),
    'secondary fuel': dict(filepath='data/demo/fuels.xlsx',
                 sheet='Fuels',
                 is_fuel = True,
                 lookup_var='secondary fuel type'),
    'fossil fuel': dict(filepath='data/demo/fuels.xlsx',
                 sheet='Fuels',
                 is_fuel = True,
                 lookup_var='fossil fuel type'),
    'biofuel': dict(filepath='data/demo/fuels.xlsx',
                 sheet='Fuels',
                 is_fuel = True,
                 lookup_var='biofuel type'),
    'secondary biofuel': dict(filepath='data/demo/fuels.xlsx',
                 sheet='Fuels',
                 is_fuel = True,
                 lookup_var='secondary biofuel type'),
    'reducing agent': dict(filepath='data/demo/fuels.xlsx',
                 sheet='Fuels',
                 is_fuel = True,
                 lookup_var='reducing agent'),
    #UPSTREAM
    'upstream outflows': dict(lookup_var='upstream outflows',
                     filepath='data/demo/upstream.xlsx',
                     sheet='up-emissions'),

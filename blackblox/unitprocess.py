...
class UnitProcess:
    ...
    def __init__(self, u_id, display_name=False, var_df=False, calc_df=False,
        ...
        if var_df is not False:
            ...
            self.var_df = iof.make_df(units_df_basedir / units_df.at[u_id, bbcfg.columns.var_filepath]
        ...
        if calc_df is not False:
            ...
            self.calc_df = iof.make_df(units_df_basedir / units_df.at[u_id, bbcfg.columns.calc_filepath], sheet=c_sheet, index=None)

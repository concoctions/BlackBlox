...
com.test_factory_scenarios(factory_dict=BECCS_factory_dict,
                        ...
                        scenario_io=False,
                        qty=qty, 
                        scenario_list=['JP-0B', 'JP-IB', 'JP-CB', 'JP-TB'], 
                        write_to_console=write_to_console, 
                        write_to_xls=write_to_xls,
                        view_diagrams=view_diagrams,
                        save_diagrams=save_diagrams,
                        outdir=f'{outdir}/BECCS-JP-Factory')
...
com.test_factory_scenarios(factory_dict=BECCS_factory_dict,
                        ...
                        scenario_io=False,
                        qty=qty, 
                        scenario_list=['RU-0B', 'RU-IB', 'RU-CB', 'RU-TB'], 
                        write_to_console=write_to_console, 
                        write_to_xls=write_to_xls,
                        view_diagrams=view_diagrams,
                        save_diagrams=save_diagrams,
                        outdir=f'{outdir}/BECCS-RU-Factory')
...
com.test_factory_scenarios(factory_dict=BECCS_factory_dict,
                        ...
                        scenario_io=False,
                        qty=qty, 
                        scenario_list=['US-0B', 'US-IB', 'US-CB', 'US-TB'], 
                        write_to_console=write_to_console, 
                        write_to_xls=write_to_xls,
                        view_diagrams=view_diagrams,
                        save_diagrams=save_diagrams,
                        outdir=f'{outdir}/BECCS-US-Factory')
...
com.test_factory_scenarios(factory_dict=BECCS_factory_dict,
                        ...
                        scenario_io=False,
                        qty=qty, 
                        scenario_list=['EU-0B', 'CH-0B', 'JP-0B', 'IN-0B', 'RU-0B', 'US-0B'], 
                        write_to_console=write_to_console, 
                        write_to_xls=write_to_xls,
                        view_diagrams=view_diagrams,
                        save_diagrams=save_diagrams,
...
com.test_factory_scenarios(factory_dict=BECCS_factory_dict,
                        ...
                        scenario_io=False,
                        qty=qty, 
                        scenario_list=['EU-IB', 'CH-IB', 'JP-IB', 'IN-IB', 'RU-IB', 'US-IB'], 
                        write_to_console=write_to_console, 
                        write_to_xls=write_to_xls,
                        view_diagrams=view_diagrams,
                        save_diagrams=save_diagrams,
...
com.test_factory_scenarios(factory_dict=BECCS_factory_dict,
                        ...
                        scenario_io=False,
                        qty=qty, 
                        scenario_list=['EU-CB', 'CH-CB', 'JP-CB', 'IN-CB', 'RU-CB', 'US-CB'], 
                        write_to_console=write_to_console, 
                        write_to_xls=write_to_xls,
                        view_diagrams=view_diagrams,
                        save_diagrams=save_diagrams,
...
com.test_factory_scenarios(factory_dict=BECCS_factory_dict,
                        ...
                        scenario_io=False,
                        qty=qty,
                        scenario_list=['EU-TB', 'CH-TB', 'JP-TB', 'IN-TB', 'RU-TB', 'US-TB'], 
                        write_to_console=write_to_console, 
                        write_to_xls=write_to_xls,
                        view_diagrams=view_diagrams,
                        save_diagrams=save_diagrams,
...
com.test_industries(BECCS_industry_dict,
                ...
                view_diagrams=view_diagrams,
                save_diagrams=save_diagrams,
                outdir=f'{outdir}/Global Industry')

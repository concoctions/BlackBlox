...
factory_dict = {
    'IBF-finish': dict(
        chain_list_file='data/steel/factories/finishing_IBF.xlsx',
    ...
    'DRI-finish': dict(
        chain_list_file='data/steel/factories/finishing_DRI.xlsx',
        chain_list_sheet='chains',
        connections_sheet='connections',
        name='DRI-0C',
        scenario='MID-0B',
    ...
    'clinker-finish': dict(
        chain_list_file='data/cement/factories/finishing_clinker.xlsx',
        chain_list_sheet='chains',
        connections_sheet='connections',
        name='clinker-0C',
        scenario='CLK-0B',

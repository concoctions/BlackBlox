...
io_dicts = chain.balance(1.0, var_i="EU-bat")

print("inputs\n", pan.DataFrame(io_dicts["i"]), "\n")
print("outputs\n", pan.DataFrame(io_dicts["o"]), "\n")

io_dicts = chain.balance(0.452447, product="CaCO3", var_i="EU-bat")

print("inputs\n", pan.DataFrame(io_dicts["i"]), "\n")
print("outputs\n", pan.DataFrame(io_dicts["o"]), "\n")

io_dicts = chain.balance(0.174018, product="clay", var_i="EU-bat")
...
io_dicts = chain.balance(1.0)

print("inputs\n", pan.DataFrame(io_dicts["i"]), "\n")
print("outputs\n", pan.DataFrame(io_dicts["o"]), "\n")

io_dicts = chain.balance(1.0, product="compressedCO2", var_i="EU-bat")

print("inputs\n", pan.DataFrame(io_dicts["i"]), "\n")
print("outputs\n", pan.DataFrame(io_dicts["o"]), "\n")

io_dicts = chain.balance(0.174018, product="CO2", var_i="EU-bat")
...
io_dicts = chain.balance(1.0, product="electricity", var_i="EU-bat")

print("inputs\n", pan.DataFrame(io_dicts["i"]), "\n")
print("outputs\n", pan.DataFrame(io_dicts["o"]), "\n")

io_dicts = chain.balance(0.174018, product="fuel", var_i="EU-old")
...
# print(factory.name)
# print(factory.factory_chains_df)
# print(factory.factory_connections_df)
# print(factory.default_product)
# print(factory.chain_list)

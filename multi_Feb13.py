...
clinker_factory_dict = {
    'CLK-0C': dict(
        chain_list_file='data/cement/factories/clinker_factory-0C.xlsx',
    ...
    'CLK-HC': dict(
        chain_list_file='data/cement/factories/clinker_factory-HC.xlsx',
        chain_list_sheet='chains',
        connections_sheet='connections',
        name='clinker-HC',
        scenario='CLK-0B',
    ...
    'CLK-CLC': dict(
        chain_list_file='data/cement/factories/clinker_factory-CLC.xlsx',
        chain_list_sheet='chains',
        connections_sheet='connections',
        name='clinker-CLC',
        scenario='CLK-0B',
...
com.test_factory_scenarios(
    factory_dict=clinker_factory_dict,
    ...
    aggregate_flows=['CO2', 'CO2__fossil', 'CO2__bio', 'CO2__calcination', 'CO2 removed',
                     'CO2 removed__downstream (calcination CO2)', 'CO2__upstream', 'stored CO2'],
...
BF_factory_dict = {
    'IBF-0C': dict(
        chain_list_file="data/steel/factories/iron_IBF_factory-0C.xlsx",
        chain_list_sheet='chains',
        connections_sheet='connections',
        name="BF-BOF-0C",
        scenario='BBF-0B',
    ...
    'IBF-HC': dict(
        chain_list_file="data/steel/factories/iron_IBF_factory-HC.xlsx",
        chain_list_sheet='chains',
        connections_sheet='connections',
        name="BF-HC",
        scenario='BBF-0B',
...
DRI_factory_dict = {
    'DRI-0C': dict(
        chain_list_file="data/steel/factories/iron_DRI_factory-0C.xlsx",
        chain_list_sheet='chains',
        connections_sheet='connections',
        name="DRI-0C",
        scenario='MID-0B',
    ...
    'DRI-HC': dict(
        chain_list_file="data/steel/factories/iron_DRI_factory-HC.xlsx",
        chain_list_sheet='chains',
        connections_sheet='connections',
        name="DRI-HC",
        scenario='MID-0B',
...
pulp_factory_dict = {
    'PLP-0C': dict(
        chain_list_file='data/paper/factories/pulp_factory-0C.xlsx',
        chain_list_sheet='chains',
        connections_sheet='connections',
        name='pulp-0C',
        scenario='PLP-0B',
    ...
    'PLP-HC': dict(
        chain_list_file='data/paper/factories/pulp_factory-HC.xlsx',
        chain_list_sheet='chains',
        connections_sheet='connections',
        name='pulp-HC',
        scenario='PLP-0B',
...
com.test_factory_scenarios(
    factory_dict=pulp_factory_dict,
